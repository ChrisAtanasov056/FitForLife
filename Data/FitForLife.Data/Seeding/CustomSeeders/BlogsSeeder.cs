        ...
        public async Task SeedAsync(FitForLifeDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            var blogs = new Blog[]
           {
               new Blog
               {
                   ...
                   ImageUrl = "https://d3h9ln6psucegz.cloudfront.net/wp-content/uploads/2017/06/Biggest-Lie-in-Fitness.jpg",
                   ...
                   Author = "Chris Atanasov"
               },
               new Blog
               {
                   Name = "10 THINGS YOU NEED TO KNOW WHEN STARTING A NEW DIET",
                   ImageUrl = "https://res.cloudinary.com/grohealth/image/upload/f_auto,fl_lossy,q_auto/v1583763560/DCUK/Content/Diet-for-Type-2-Diabetes.png",
